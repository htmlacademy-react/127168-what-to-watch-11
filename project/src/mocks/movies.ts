...
const movies: Movies = [
  {
    name: 'A Star Is Born',
    posterImage: 'img/poster/A_Star_Is_Born.jpg',
    previewImage: 'img/preview/A_Star_Is_Born.jpg',
    backgroundImage: 'img/background/A_Star_is_Born.jpg',
  ...
  },
  {
    ...
    posterImage: 'img/poster/Moonrise_Kingdom.jpg',
    previewImage: 'img/preview/moonrise-kingdom.jpg',
    backgroundImage: 'img/background/Moonrise_Kingdom.jpg',
  ...
  {
    name: 'Legend',
    posterImage: 'img/poster/Legend.jpg',
    previewImage: 'img/preview/legend.jpg',
    backgroundImage: 'img/background/legend.jpg',
  ...
  },
  {
    ...
    posterImage: 'img/poster/Fantastic_Beasts.jpg',
    previewImage: 'img/preview/fantastic-beasts-the-crimes-of-grindelwald.jpg',
    backgroundImage: 'img/background/Fantastic_Beasts.jpg',
  ...
  },
  {
    ...
    posterImage: 'img/poster/Midnight_Special.jpg',
    previewImage: 'img/preview/midnight-special.jpg',
    backgroundImage: 'img/background/Midnight_Special.jpg',
  ...
  {
    name: 'Matrix',
    posterImage: 'img/poster/matrix.jpg',
    previewImage: 'img/preview/matrix.jpg',
    backgroundImage: 'img/background/matrix.jpg',
  ...
  {
    name: 'Pulp Fiction',
    posterImage: 'img/poster/Pulp_Fiction.jpg',
    previewImage: 'img/preview/pulp-fiction.jpg',
    backgroundImage: 'img/background/Pulp_Fiction.jpg',
  ...
  {
    name: 'Shutter Island',
    posterImage: 'img/poster/Shutter_Island.jpg',
    previewImage: 'img/preview/shutter-island.jpg',
    backgroundImage: 'img/background/Shutter_Island.jpg',
